...
public class CharPointAtDemo {
    ...
    public static void main(String[] args) {
        System.out.println("\n=== JSString.codePointAt Demo ===");

        // ASCII: "Hello"
        JSString hello = JSString.of("Hello");
        int result1 = hello.codePointAt(0);
        int result2 = hello.codePointAt(4);
        System.out.println("\"Hello\".codePointAt(0): " + result1);
        System.out.println("\"Hello\".codePointAt(4): " + result2);
        // Expected:
        ...
        System.out.println("\"←↑→↓\".codePointAt(0): " + result3);
        System.out.println("\"←↑→↓\".codePointAt(2): " + result4);
        // Expected:
        // "←↑→↓".charCodeAt(0): 8592
        // "←↑→↓".charCodeAt(2): 8594
        ...
        System.out.println("\"∑√π∞\".codePointAt(1): " + result5);
        System.out.println("\"∑√π∞\".codePointAt(3): " + result6);
        // Expected:
        // "∑√π∞".charCodeAt(1): 8730
        // "∑√π∞".charCodeAt(3): 8734
        ...
        System.out.println("\"€¥₹$\".codePointAt(2): " + result7);
        System.out.println("\"€¥₹$\".codePointAt(3): " + result8);
        // Expected:
        // "€¥₹$".charCodeAt(2): 8377
        // "€¥₹$".charCodeAt(3): 36
