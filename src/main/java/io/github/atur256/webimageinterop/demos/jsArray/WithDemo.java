...
public class WithDemo {
    ...
    public static void main(String[] args) {
        ...
        assertArray(updated1, Integer.class, 1, 99, 3);
        ...
        assertArray(updated2, Integer.class, 3, 4, 10);
        ...
        assertArray(updated3, Double.class, 1.4, 2.6, 5.6, 11.45);
        ...
        assertArray(updated4, String.class, "apple", "pear", "orange");
        ...
        assertArray(updated5, Boolean.class, true, false, true, true);
