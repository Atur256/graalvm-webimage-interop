...
public class LastIndexOfDemo {
    ...
    public static void main(String[] args) {
        ...
        int index1 = javaArr1.lastIndexOf("a"); // TODO: does not work
        System.out.println("Last index of 'a': " + index1);
        // Expected: Last index of 'a': 2

        JSArray javaArr2 = JSArray.of(new int[]{1, 2, 1, 4, 6, 12, 3, 6, 3, 2});
        ...
        JSArray javaArr3 = JSArray.of(new double[]{1.3, 5.6, 1.3, 6.7, 3.2});
