...
public class JoinDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Joined: " + joined1); // Expected: "apple, banana"

        JSArray javaArr1 = JSArray.of("apple", "banana", "orange");
        String joined2 = javaArr1.join(", ");
        System.out.println("Joined: " + joined2); // Expected: "apple, banana, orange"

        JSArray javaArr2 = JSArray.of(1, 2, 3, 4, 5, 6);
        String joined3 = javaArr2.join(" | ");
        System.out.println("Joined: " + joined3); // Expected: "1 | 2 | 3 | 4 | 5 | 6"
    }
}
